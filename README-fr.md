...
> [!WARNING]
> Projet réalisé uniquement à des fins pédagogiques et contient des éléments non libre de droit.
> Aucun contenu n’est utilisé à des fins lucratives. Merci de ne pas copier ni réutiliser le contenu sans autorisation.
...
- Hachage des mots de passe pour un système plus sécurisé (manque de temps)
...
- Certaines parties ne respectent pas totalement le principe D.R.Y (Don't Repeat Yourself), notamment le JS pour les fonctions `toggleIcon`.  

## Installation et exécution
1. Executer : main.py
2. Accéder à l'application via `http://127.0.0.1:5559` ou `http://192.168.1.48:5559` 
> Grâce à la 2ème URL, vous pouvez vous connecter au site depuis un autre ordinateur local

## ©️ Crédits
- Développement : Titouan Moquet 
- Année scolaire : Terminal 2024-2025

> Version actuel : V2.5 / Release_1.2  

<!-- last editing 15/01/2026 -->
